...
const Hero = () => {
  return (
    <div className="max-w-[800px] px-10 md:px-0 mt-[-96px] w-full min-h-screen mx-auto text-center flex flex-col justify-center text-white">
        ...
        <a href="#!" className="bg-deepSkyBlue w-[200px] rounded-md font-medium my-6 mx-auto py-3 text-black hover:bg-plum">Rejoins-nous</a>
    </div>
  )
}
