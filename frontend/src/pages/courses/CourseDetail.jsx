            ...
            <section className="bg-white min-h-screen text-black flex">
                <div className="max-w-[1240px]  px-3 mx-auto grid lg:grid-cols-3">
                    <div className="self-center col-span-2 flex flex-col ">
                        ...
                        <a href="/register" className="bg-black w-[150px] sm:w-[200px] rounded-md text-sm sm:text-base sm:font-medium my-6 py-2 sm:py-3 text-deepSkyBlue text-center hover:bg-plum hover:text-black duration-300">Rejoins-nous</a>
                    </div>
