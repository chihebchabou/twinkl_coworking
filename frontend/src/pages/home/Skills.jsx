    ...
    return ( 
        ...
        <div className="max-w-[1240px] mx-auto grid md:grid-cols-2">
            ...
            <div className="flex flex-col justify-center text-center md:text-left">
                ...
                <a href="/register" className="bg-black w-[200px] rounded-md font-medium my-6 mx-auto md:mx-0 py-3 text-deepSkyBlue text-center hover:bg-plum hover:text-black duration-300">Rejoins-nous</a>
            </div>
        </div>
    </div>
    );
