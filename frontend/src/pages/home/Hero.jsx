...
const Hero = () => {
  return (
    <div className="max-w-[800px] px-10 md:px-0 w-full min-h-screen mx-auto text-center flex flex-col justify-center text-white">
        ...
        <h1 className="md:text-5xl sm:text-4xl text-2xl font-bold md:pb-6">Développe tes compétences, accomplis tes ambitions <br />   et réussis ta carrière.</h1>
        ...
        <p className="md:text-2xl text-xl font-bold text-gray-500">Les compétences d&apos;aujourd’hui, les succès de demain.</p>
